...
export const adminPages: AdminPageDefinition[] = [
  ...
  { key: "match-reschedule-requests", href: "/admin/match-reschedule-requests", label: "Žádosti termínů", defaultMinimumRole: "moderator" },
  { key: "tournament-requests", href: "/admin/tournament-requests", label: "Žádosti turnajů", defaultMinimumRole: "moderator" },
  ...
  { key: "export", href: "/admin/export", label: "Export", defaultMinimumRole: "admin" },
  { key: "export-players-all", href: "/admin/export/hraci-vsichni", label: "Hráči - všichni", defaultMinimumRole: "admin", parentKey: "export" },
  { key: "tables", href: "/admin/tables", label: "Tabulky", defaultMinimumRole: "moderator" },
  { key: "facebook", href: "/admin/facebook", label: "Facebook", defaultMinimumRole: "admin" },
...
export function adminPageForAdminApiPath(pathname: string) {
  const mappings: Array<{ prefix: string; key: string }> = [
    ...
    { prefix: "/api/admin/match-reschedule-requests", key: "match-reschedule-requests" },
    { prefix: "/api/admin/tournament-requests", key: "tournament-requests" },
    ...
    { prefix: "/api/admin/export/players", key: "export-players-all" },
    { prefix: "/api/admin/tables", key: "tables" },
    { prefix: "/api/admin/facebook", key: "facebook" },
